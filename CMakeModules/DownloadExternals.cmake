...
set(prefix "${PROJECT_BINARY_DIR}/externals/${lib_name}")
if (NOT EXISTS "${prefix}")
    message(STATUS "Downloading binaries for ${lib_name}...")
    file(DOWNLOAD
        https://github.com/vvanelslande/vvctre-windows-dependency-binaries/raw/master/${remote_path}${lib_name}.7z
        "${PROJECT_BINARY_DIR}/externals/${lib_name}.7z" SHOW_PROGRESS)
    execute_process(COMMAND ${CMAKE_COMMAND} -E tar xf "${PROJECT_BINARY_DIR}/externals/${lib_name}.7z"
